...
import bobuRun from '../assets/run.gif'
import bobuIdle from '../assets/idle.gif'
import bobuThumbs from '../assets/thumbsup.gif'
...
export default function GovernancePage() {
  ...
  useEffect(() => {
    ...
    // Randomize background Bobu GIF on each visit/refresh
    const picks = [bobuRun, bobuIdle, bobuThumbs]
    const chosen = picks[Math.floor(Math.random() * picks.length)]
    document.documentElement.style.setProperty('--governance-bg-gif', `url(${chosen})`)
    return () => {
