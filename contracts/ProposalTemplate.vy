...
#
# ProposalTemplate
# - Clonable per-proposal instance initialized by GovernanceHub
# - Stores proposal metadata and voting window
# - Keeps comment addresses and exposes pagination
# - Records votes via hub-only method (simple 1 address = 1 vote by default)
...
@external
def initialize(_hub: address, _title: String[128], _author: address, _body: String[1024], _createdAt: uint256, _voteStart: uint256, _voteEnd: uint256):
