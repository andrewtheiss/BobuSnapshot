...
#
# CommentTemplate
# - Clonable per-comment instance initialized by GovernanceHub
# - Links to a proposal and stores content metadata
# - Soft-deletable by the hub admins within 2 weeks
